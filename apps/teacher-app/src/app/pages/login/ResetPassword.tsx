      ...
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md border border-gray-100">
        ...
        <div className="flex flex-col items-center mb-6">
          <img
            ...
            className="h-28 mb-2"
          />
          <h1 className="text-2xl font-semibold text-gray-700">Tạo lại mật khẩu</h1>
        </div>
        ...
        <div className="space-y-5">
          <div className="relative">
            ...
            <div className="w-full text-center"><button className="btn btn-primary mt-8" onClick={() => handleResetPassword()}>Tạo</button></div>
          </div>
